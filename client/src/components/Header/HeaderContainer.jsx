  ...
  return (
    <div
      className={clsx(
        ...
        {
          "border-dark-primary/20 max-w-[calc(100%-24px)] mobile:max-w-[calc(100%-32px)] tablet-portrait:max-w-[calc(100%-48px)] laptop:max-w-275 py-3 mobile:py-3.5 laptop:py-4 px-4 mobile:px-5 tablet-portrait:px-6 laptop:px-8 rounded-2xl bg-background-secondary/60 backdrop-blur-xl shadow-lg shadow-black/30":
            isScrolled,
