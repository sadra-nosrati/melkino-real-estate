...
function AuthPage() {
  ...
  return (
    <div className="relative flex flex-col min-h-screen items-center justify-center overflow-hidden bg-[#0F0F0F] px-4 tablet-portrait:px-6 w-full py-8 tablet-landscape:py-0">
      <Link
        to="/"
        className="mb-8 tablet-landscape:mb-10 text-center text-3xl mobile-landscape:text-4xl tablet-landscape:text-5xl font-black pl-3 tablet-landscape:pl-5 tracking-[0.25em] tablet-landscape:tracking-[0.4em] text-dark-primary drop-shadow-[0_0_25px_rgba(242,202,80,0.35)] animate-glow transition-all duration-500 hover:scale-105 select-none"
      >
        MELKINO
      </Link>
